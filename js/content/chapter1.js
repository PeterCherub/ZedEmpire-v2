...
export const cards = {
  c1_wake: {
    ...
    left: {
      ...
      effects: { deltas: { food: -5, security: -3 } },
    },
    right: {
      label: "Beg",
  ...
  c2_job: {
    ...
    left: {
      ...
      effects: { deltas: { money: 60, food: -5, security: -3, skill: 2, reputation: 1 } },
    },
    right: {
  ...
  c3_suspicious: {
    ...
    left: {
      ...
      effects: { deltas: { money: 150, food: -5, security: -3 }, flags: { suspicious_goods: true } },
    },
    right: {
      label: "Walk away",
  ...
  c4_police: {
    ...
    right: {
      ...
      effects: { deltas: { food: -5, security: -3, money: -100, reputation: -5 } },
    },
  },
  ...
  c5_family: {
    ...
    left: {
      ...
      effects: { deltas: { money: -50, food: -5, security: -3, reputation: 8 } },
    },
    right: {
      label: "Say you have nothing",
      result: "She doesn't argue, but the silence says enough.",
      effects: { deltas: { food: -3, security: -1, reputation: -5 } },
    },
  },
  ...
  c6_market: {
    ...
    left: {
      ...
      effects: { deltas: { food: -5, security: -3, reputation: 5, skill: 2 } },
    },
    right: {
      label: "Walk past",
  ...
  c7_offer: {
    ...
    left: {
      ...
      effects: { deltas: { food: -5, security: -3, skill: 3, territory: 5 }, flags: { transport_opportunity: true } },
    },
    right: {
      label: "Decline",
  ...
  c8_market_raid: {
    ...
    left: {
      ...
      effects: { deltas: { food: -5, security: -3, reputation: -2 } },
    },
    right: {
  ...
  c9_charity: {
    ...
    left: {
      ...
      effects: { deltas: { food: 15, security: -3, reputation: -2 } },
    },
    right: {
  ...
  c10_stranger: {
    ...
    left: {
      ...
      effects: { deltas: { food: -3, security: -3, money: -200, reputation: -5 }, flags: { conned: true } },
    },
    right: {
      label: "Refuse",
  ...
  c11_transport: {
    ...
    left: {
      ...
      effects: { deltas: { food: -5, security: -3, money: -200, territory: 15, reputation: 5 }, flags: { transport_active: true } },
    },
    right: {
      label: "Back out",
  ...
  c13_night_shelter: {
    ...
    right: {
      ...
      effects: { deltas: { food: -5, security: -5, reputation: -2 } },
    },
  },
  ...
  c14_stolen_goods: {
    ...
    left: {
      ...
      effects: { deltas: { money: -50, security: -10, skill: 2 }, flags: { stolen_goods: true } },
    },
    right: {
      label: "Refuse",
  ...
  c15_friend: {
    ...
    right: {
      ...
      effects: { deltas: { food: -3, security: -3, reputation: -2 } },
    },
  },
};
