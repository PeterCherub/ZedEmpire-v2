...
export const cards = {
  ...
  cb_gate_labor: {
    ...
    left: {
      ...
      effects: { deltas: { money: 70, food: -8, security: -3, skill: 2 } },
    },
    right: {
  ...
  cb_jerabo: {
    ...
    left: {
      ...
      effects: { deltas: { money: 90, food: -6, security: -8 }, flags: { jerabo_ties: true } },
    },
    right: {
      label: "Refuse",
  ...
  cb_union: {
    ...
    left: {
      ...
      effects: { deltas: { reputation: 6, security: -2, skill: 1 }, flags: { union_ally: true } },
    },
    right: {
  ...
  cb_cable_offer: {
    ...
    left: {
      ...
      effects: { deltas: { money: -30, security: -5 }, flags: { stolen_copper: true } },
    },
    right: {
      label: "Walk away",
  ...
  cb_security_search: {
    ...
    right: {
      ...
      effects: { deltas: { food: -5, security: -5, reputation: -6 } },
    },
  },
  ...
  cb_smelter_job: {
    ...
    left: {
      ...
      effects: { deltas: { money: 85, food: -8, security: -4, skill: 3 } },
    },
    right: {
      label: "Pass on it",
  ...
  cb_shaft_collapse: {
    ...
    left: {
      ...
      effects: { deltas: { reputation: 9, skill: 3, food: -10, security: -3 } },
    },
    right: {
      label: "Stay clear",
  ...
  cb_cough: {
    ...
    right: {
      ...
      effects: { deltas: { food: -5, security: -6 } },
    },
  },
  ...
  cb_cousin_butchery: {
    ...
    left: {
      ...
      effects: { deltas: { money: -60, food: -3, reputation: 7 } },
    },
    right: {
  ...
  cb_jerabo_raid: {
    ...
    left: {
      ...
      effects: { deltas: { money: -40, food: -8, security: -3 } },
    },
    right: {
      ...
      effects: { deltas: { money: 50, food: -5, security: -10, reputation: -3 } },
    },
  },
  ...
  cb_departure: {
    ...
    right: {
      ...
      effects: { deltas: { food: -5, security: -4, money: 10 } },
    },
  },
};
