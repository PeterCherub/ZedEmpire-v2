...
export const cards = {
  c4_begin: {
    ...
    right: {
      ...
      effects: { deltas: { money: 10, security: -2, food: -3 } },
    },
  },
  ...
  c4_work: {
    ...
    left: {
      ...
      effects: { deltas: { money: 45, food: -5, skill: 2, reputation: 1 } },
    },
    right: {
  ...
  c4_community: {
    ...
    right: {
      ...
      effects: { deltas: { food: -3, security: -2, money: 5 } },
    },
  },
  ...
  c4_journey: {
    ...
    right: {
      ...
      effects: { deltas: { food: -5, security: -5, money: 10 } },
    },
  },
  ...
  c4_test: {
    ...
    right: {
      ...
      effects: { deltas: { food: 5, reputation: -5, security: -2 } },
    },
  },
};
