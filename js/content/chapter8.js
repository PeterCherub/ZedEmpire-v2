...
export const cards = {
  ...
  so_herding_job: {
    ...
    left: {
      ...
      effects: { deltas: { money: 45, food: 5, security: -5, skill: 2 } },
    },
    right: {
      label: "Decline",
  ...
  so_drought_relief: {
    ...
    left: {
      ...
      effects: { deltas: { food: 15, security: -4 } },
    },
    right: {
  ...
  so_cattle_deal: {
    ...
    left: {
      ...
      effects: { deltas: { money: -120, territory: 10, security: -6 }, flags: { rustled_cattle: true } },
    },
    right: {
      label: "Refuse",
  ...
  so_livestock_officer: {
    ...
    left: {
      ...
      effects: { deltas: { territory: -10, reputation: -6, security: -3 }, flags: { criminal_record: true } },
    },
    right: {
      ...
      effects: { deltas: { food: -8, security: -8, skill: 1 } },
    },
  },
  ...
  so_border_run: {
    ...
    left: {
      ...
      effects: { deltas: { money: 80, food: -3, security: -5 }, flags: { border_runner: true } },
    },
    right: {
      label: "Refuse",
  ...
  so_customs_stop: {
    ...
    left: {
      ...
      effects: { deltas: { reputation: -4, security: -2 } },
    },
    right: {
  ...
  so_well_digging: {
    ...
    left: {
      ...
      effects: { deltas: { reputation: 8, skill: 2, food: -10, security: -3 } },
    },
    right: {
      ...
      effects: { deltas: { money: -20, reputation: 2, food: -3 } },
    },
  },
  ...
  so_maize_failure: {
    ...
    right: {
      ...
      effects: { deltas: { food: 6, security: -2 } },
    },
  },
  ...
  so_uncle_vaccine: {
    ...
    left: {
      ...
      effects: { deltas: { money: -40, food: -3, reputation: 6 } },
    },
    right: {
  ...
  so_charcoal: {
    ...
    left: {
      ...
      effects: { deltas: { money: 55, food: -6, security: -4 }, flags: { illegal_charcoal: true } },
    },
    right: {
      label: "Decline",
  ...
  so_zambezi_crossing: {
    ...
    right: {
      ...
      effects: { deltas: { money: -5, security: -5, food: -2 } },
    },
  },
  ...
  so_departure: {
    ...
    right: {
      ...
      effects: { deltas: { food: -8, security: -4, skill: 1 } },
    },
  },
};
